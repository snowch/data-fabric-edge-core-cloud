 ...
 * 
 */
public class ImageClassifierService extends Thread {
	
	public static final String APP_CODE = "IMG_CLASS_1";
	public static final String APP_DISPLAY_NAME = "Image Classifier 1.0 Service";
	...
	public ImageClassifierService(String threadID) {
		...
		logger = new MessageLogger(APP_CODE, APP_DISPLAY_NAME, threadID);
	...
	public void run() {
		...
		inputStreamConsumer = StreamsHelper.getConsumer("classifier", null);
	            	...
	            	if (keepRunning) {
		            	...
		            	try {    // Errors caught here will be written to stdout.  
		            		...
		            		JsonNode msg = mapper.readTree(record.value());
			  			  	...
			  			  	try {      // Errors caught here will be surfaced in the Dashboard.
				            	...
				            	if (assetDoc == null) {
				            		...
				            		String labels = imageClassifier.classifyImage(filenameFQN, 1);
				            		...
				            		DocumentMutation mutation = MapRDB.newMutation().set("imageClassificationsV1", labels);
				            		imagesTable.update(assetID, mutation);
				            		imagesTable.flush();
				            		logger.logMessage( pid, MessageLogger.MSG_LEVEL_INFO, MessageLogger.CD_MSG_TEXT, "Updated image metadata with v1 category labels.");
